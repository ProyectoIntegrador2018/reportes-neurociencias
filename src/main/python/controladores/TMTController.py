...
class TMTController(QtWidgets.QWidget, ControllerModel):
	...
	def __init__(self, mainWindow, reporteModel=None):
		...
		self.tmtView.backButton.clicked.connect(self.returnView)
	...
	def returnView(self):
		...
		"""
		self.switch_window.emit(self.invalidArgs, self.tmtPrueba, True)
	
	def changeView(self):
		"""
		 Método encargado de notificar los elementos que serán pasados como parámetros a la siguiente vista
		"""
		self.switch_window.emit(self.invalidArgs, self.tmtPrueba, False)
