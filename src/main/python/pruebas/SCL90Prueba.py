...
class SCL90Prueba(PruebaModel.PruebaModel):	
	def __init__(self, valores):
		nombre = "SCL-90"
		baremos = (pd.read_csv(APPCTXT().get_resource('./Baremos/SCL90R_MUJERES_NC_TABLA.csv')),
					pd.read_csv(APPCTXT().get_resource('./Baremos/SCL90R_VARONES_NC_TABLA.csv')), 
					pd.read_csv(APPCTXT().get_resource('./Baremos/SCL90R_MUJERES_PSIQUIATRICA_TABLA.csv')), 
					pd.read_csv(APPCTXT().get_resource('./Baremos/SCL90R_VARONES_PSIQUIATRICA_TABLA.csv')),
					pd.read_csv(APPCTXT().get_resource('./Baremos/SCL90R_PSICOSOMATICA_TABLA.csv')))
