...
class MainWindowWithListWidget(object):
    ...
    def setupUi(self, Form):
        ...
        self.leLateralidad = QtWidgets.QLineEdit(self.verticalLayoutWidget)
        self.leLateralidad.setObjectName("leLateralidad")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.leLateralidad)
